...
#Checking if the columns names in the metadata matches column names
#"id, name etc."
...
#Checking if the metadata conists of a reasonable number of rows
...
#Checks if columns match the expected type
...
#Checks if the number of maximum missing values (200) are within the threshold
...
#Checks if correct timezone has been applied
